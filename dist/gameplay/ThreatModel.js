...
export class ThreatModel {
    ...
    calculateVibrationRadius(context) {
    ...
    hasLineOfSight(source, obstacles) {
    ...
    intersectsLine(from, to, obstacle) {
        const x1 = from.x;
        const y1 = from.y;
        const x2 = to.x;
        const y2 = to.y;
...
//# sourceMappingURL=ThreatModel.js.map