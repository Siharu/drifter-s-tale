...
export const INITIAL_HUSK_RECORDS = [
    {
        id: 'husk-skoth',
        type: HuskType.SKOTH,
        discoveredName: null,
...
export const INITIAL_INFECTED_RECORDS = [
    {
...
export const INITIAL_GHUUL_RECORD = {
    id: 'ghuul-apex',
    type: GhuulType.APEX,
    discoveredName: null,
    physicalTraits: 'Pure white skin and hair (normally). Eyes flicker between brown and black. Visible internal conflict: backs cracked open, flesh held by string-like tissue. Movement glitches between realities.',
    detectionMethods: [
        DetectionMethod.SIGHT,
        DetectionMethod.VIBRATION,
        DetectionMethod.BEHAVIOR,
    ],
    behavior: 'Acts with PURPOSE and AGENCY. Makes deliberate choices. Retains EMOTION (love, recognition, protection of loved ones observed). Does not mindlessly consume. Operates with unknown goals. ~173 known worldwide.',
    threatLevel: 'EXTREME',
    weakness: 'NONE KNOWN. Shooting brain does not stop them. Physical damage does not stop them. Rain of Obsedia briefly turns skin brown (moment of restored humanity) — unclear if vulnerability exists during this state.',
    preventionTip: 'Avoid. Do not engage. If encountered: observe behavior and report to WNCORE. Some ghuuls protect rather than attack (unknown criteria). Contact WNCORE leadership immediately with location/behavior data.',
    encounterCount: 0,
    notes: 'Most dangerous and least understood. Some show protection behavior toward humans (mother protecting child reported). Others destroy survivor camps (reasons unknown). WNCORE tracks all 173 known individuals. This is apex threat AND potential unknown ally.',
};
//# sourceMappingURL=husk_records.js.map